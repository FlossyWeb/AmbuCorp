...
function Share()
{
	...
	var message = "Téléchargez l'app Ambu Life en suivant ce lien : http://www.taximedia.fr/stores.php?app=ambulife";
	var intent = ""; //leave empty for sending sms using default intent
	var success = function () {
...
{
	var number = $('#telShare').val();
	var message = "Téléchargez l'app Ambu Corp en suivant ce lien : http://www.taximedia.fr/stores.php?app=ambucorp";
	var intent = ""; //leave empty for sending sms using default intent
	var success = function () {
		//alert('Message sent successfully');
		$('#smsReturn').empty().append('Message envoy&eacute; avec succ&egrave;s, Merci');
...
{
	var number = $('#telShare').val();
	var message = "Rendez-vous sur le WebService Ambu Life en suivant ce lien : http://ecra.se/AA";
	var intent = ""; //leave empty for sending sms using default intent
	var success = function () {
		//alert('Message sent successfully');
		$('#smsReturn').empty().append('Message envoy&eacute; avec succ&egrave;s, Merci');
...
{
	var number = $('#telShare').val();
	var message = "Téléchargez l'app Ambu Life sur les sores en suivant ce lien : http://www.taximedia.fr/stores.php?app=ambulife  ou rendez-vous sur le WebService en suivant ce lien : http://ecra.se/3jt";
	var intent = ""; //leave empty for sending sms using default intent
	var success = function () {
		//alert('Message sent successfully');
		$('#smsReturn').empty().append('Message envoy&eacute; avec succ&egrave;s, Merci');
